...
formAddingBook.addEventListener("submit", function (event) {
  const title = document.getElementById("iBookTitle").value;
  const author = document.getElementById("iBookAuthor").value;
  const year = parseInt(document.getElementById("iBookYear").value);
  const isComplete = document.getElementById("iBookIsComplete").checked;

  const idTemp = document.getElementById("iBookTitle").name;
  if (idTemp !== "") {
...
function UpdateAnItem(itemElement) {
  ...
  document.getElementById("iBookTitle").value = title;
  document.getElementById("iBookTitle").name = id;
  document.getElementById("iBookAuthor").value = author;
  document.getElementById("iBookYear").value = year;
  document.getElementById("iBookIsComplete").checked = isComplete;
...
function ResetAllForm() {
  document.getElementById("iBookTitle").value = "";
  document.getElementById("iBookAuthor").value = "";
  document.getElementById("iBookYear").value = "";
  document.getElementById("iBookIsComplete").checked = false;
